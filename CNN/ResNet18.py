...
class ResNet18(nn.Module):
    ...
    def __init__(self, num_classes=NUM_CLASSES):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False) # disable bias with BN following
                                                                                      # 224x224 -> 112x112
        self.bn1 = nn.BatchNorm2d(64)
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1) # 112x112 -> 56x56
        
        self.layer1 = self._make_layer(64, 64, num_blocks=2, stride=1) # 56x56 -> 56x56
        self.layer2 = self._make_layer(64, 128, num_blocks=2, stride=2) # 56x56 -> 28x28
        self.layer3 = self._make_layer(128, 256, num_blocks=2, stride=2) # 28x28 -> 14x14
        self.layer4 = self._make_layer(256, 512, num_blocks=2, stride=2) # 14x14 -> 7x7
